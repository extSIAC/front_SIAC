<?php
    ...
    $consulta = $MU->Registrar_Usuario_Promotor_Actividades_Deportivas($REG_PRO_NOMBRE, $REG_PRO_APELLIDO_PATERNO, $REG_PRO_APELLIDO_MATERNO, $REG_PRO_EDAD, $REG_PRO_SEXO, $REG_PRO_TELEFONO, $REG_PRO_CORREO, $REG_PRO_USUARIO, $REG_PRO_CONTRASENA);
    echo $consulta;
