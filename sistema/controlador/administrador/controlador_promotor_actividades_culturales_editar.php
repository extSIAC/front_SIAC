<?php
    ...
    $consulta = $MU->Editar_Usuario_Promotor_Actividades_Culturales($EDIT_PRO_ID_PROMOTOR,$EDIT_PRO_NOMBRE, $EDIT_PRO_APELLIDO_PATERNO, $EDIT_PRO_APELLIDO_MATERNO, $EDIT_PRO_EDAD, $EDIT_PRO_SEXO, $EDIT_PRO_TELEFONO, $EDIT_PRO_CORREO);
    echo $consulta;
